...
def tools_energy(req, account_id):
    ...
    current_fusion_cost = costs_onepointeight_total(fusion_base_cost, average_fusion)
    ...
    current_energy_cost = costs_two_total(energy.base_cost, energy.level)
    ...
    this_prod = int(get_fusion_production(average_fusion, energy=energy.level)[3])
    ...
    for i in range(0, 5):
        ...
        for j in range(0, 5):
            ...
            et_cost = costs_two_total(energy.base_cost, et)
